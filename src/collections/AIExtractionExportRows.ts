...
export const AIExtractionExportRows: CollectionConfig = {
  ...
  fields: [
    ...
    textField("documentId", "Document ID", { index: true }),
    ...
    textField("aiExtractionId", "AI Extraction ID", { index: true }),
    ...
    textField("statusId", "Status ID", { index: true }),
